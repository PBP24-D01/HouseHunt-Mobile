...
class _CekRumahSellerState extends State<CekRumahSeller> {
  ...
  Future<void> fetchData() async {
    ...
    final availabilitiesResponse = await request.get(
        'https://tristan-agra-househunt.pbp.cs.ui.ac.id/cekrumah/api/availabilities/');
    // Fetch appointments
    final appointmentsResponse = await request.get(
        'https://tristan-agra-househunt.pbp.cs.ui.ac.id/cekrumah/api/appointments/');
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            Color(0xFF4A628A), // Primary color applied
                      ),
                      child: Text(
                        'Add Availability',
                        style: TextStyle(color: Colors.white),
                              ...
                              SingleChildScrollView(
                                ...
                                child: DataTable(
                                  ...
                                  rows: appointments.map((appointment) {
                                    ...
                                    return DataRow(cells: [
                                      DataCell(Text(appointment['buyer']
                                              ['username'] ??
                                          '')),
                                      DataCell(Text(
  ...
  Future<void> deleteAvailability(int availabilityId) async {
    ...
    final response = await request.post(
      'https://tristan-agra-househunt.pbp.cs.ui.ac.id/cekrumah/api/availability/delete/',
      jsonEncode(data),
    );
  ...
  Future<void> updateAvailability(
      int availabilityId, Availability updatedAvailability) async {
    final request = context.read<CookieRequest>();
    ...
    final response = await request.post(
      'https://tristan-agra-househunt.pbp.cs.ui.ac.id/cekrumah/api/availability/update/',
      jsonEncode(data),
    );
  ...
  Future<void> createAvailability(Availability availability) async {
    final request = context.read<CookieRequest>();
    final response = await request.post(
      'https://tristan-agra-househunt.pbp.cs.ui.ac.id/cekrumah/api/create_availability/',
  ...
  Future<void> updateAppointmentStatus(
    ...
    final response = await request.post(
      'https://tristan-agra-househunt.pbp.cs.ui.ac.id/cekrumah/api/update_appointment_status/',
      jsonEncode(data),
    );
