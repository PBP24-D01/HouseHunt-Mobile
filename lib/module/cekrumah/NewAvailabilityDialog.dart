...
class NewAvailabilityDialog extends StatefulWidget {
  ...
  const NewAvailabilityDialog({Key? key, this.existingAvailability})
      : super(key: key);
...
class _NewAvailabilityDialogState extends State<NewAvailabilityDialog> {
  ...
  void initState() {
    ...
    if (widget.existingAvailability != null) {
      ...
      _availableDate =
          DateTime.parse(widget.existingAvailability!['available_date']);
  ...
  Future<void> _fetchHouses() async {
    ...
    final response = await request.get(
        'https://tristan-agra-househunt.pbp.cs.ui.ac.id/cekrumah/api/seller_houses/');
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(widget.existingAvailability != null
          ? 'Edit Availability'
          : 'New Availability'),
      content: _isLoading
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null && pickedDate != _availableDate) {
                        setState(() {
                          ...
                          _availableDateController.text = _availableDate!
                              .toIso8601String()
                              .substring(0, 10);
                        });
                      }
                      ...
                      if (pickedTime != null) {
                        setState(() {
                          ...
                          _startTimeController.text =
                              _startTime!; // Format the time as HH:mm
                        });
                      }
                    },
                      ...
                      if (pickedTime != null) {
                        setState(() {
                          ...
                          _endTimeController.text =
                              _endTime!; // Format the time as HH:mm
                        });
                      }
                    },
